...
if (!adminExists) {
  ...
  var seed = [
    ...
    ['p_seed2','高等数学（第七版）上册',15,'book','9成新','只用了一学期，几乎全新，没有笔记划痕','sys_demo','老王',5],
    ['p_seed3','美利达山地自行车',450,'sports','7成新','26寸山地车，变速正常，刹车灵敏，送车锁','sys_demo','骑行爱好者',3],
    ['p_seed4','宿舍用迷你小风扇',25,'life','9成新','USB接口，三档风速，静音设计','sys_demo','小张',1],
    ['p_seed5','机械键盘 Cherry轴',200,'digital','8成新','IKBC C87，Cherry红轴，PBT键帽','sys_demo','码农小王',7],
    ['p_seed6','大学英语四级词汇书',10,'book','7成新','新东方四级词汇词根+联想记忆法','sys_demo','英语达人',4],
    ['p_seed7','冬季棉服外套',60,'clothes','8成新','男生L码，穿过一季，洗干净了','sys_demo','阿杰',6],
    ['p_seed8','瑜伽垫 加厚10mm',30,'sports','9成新','买来只用了几次，加厚防滑，送收纳绑带','sys_demo','爱运动的女孩',2],
  ];
  seed.forEach(function(s){
    insert('products', { id:s[0], name:s[1], price:s[2], category:s[3], condition:s[4], description:s[5], seller_id:s[6], seller_name:s[7], images:'[]', status:'active', created_at:new Date(Date.now()-86400000*s[8]).toISOString() });
  });
}
